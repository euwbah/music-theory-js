...
// Use this on the first pass to separate parts of the chord
...
class Chord {
  constructor(str) {
    ...
    // Remove parens once alterations has been (more) accurately separated from
    // the extension
    ...
    if (MAJ_CHARS.includes(quality) ||
      ...
      // The chord is erroneous... time to find out what went wrong...
    ...
    } else if (['#11', '15', '#15'].includes(extension)) {
